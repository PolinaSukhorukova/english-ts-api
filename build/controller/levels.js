...
const levelService = __importStar(require("../services/levels"));
const getLevels = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const levels = yield levelService.getLevels();
    res.send(levels);
});
...
const getLevelById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const foundLevel = yield levelService.getLevelById(+levelId);
    if (!foundLevel) {
        res.sendStatus(404);
        return;
    }
